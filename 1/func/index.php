...
<style type="text/css">.table_dark {
...
<body>
 ...
 <div class="add_user_main_panel">
    ...
    <tr>
        <th>UID</th> <th>ПІБ</th> <th>Стать</th> <th>Курс і група</th> <th>№ паспорта</th> <th>Прописка</th> <th>Справка з воєнкомату</th> <th>Прияняття і відрахування з коледжу</th> <th>Зміни</th>  
    </tr>
    <?php  
    while($user_data = mysqli_fetch_array($result)) {         
        ...
        echo "<br><td><a href='edit.php?id=$user_data[id]'>Edit</a> | <a href='delete.php?id=$user_data[id]'>Delete</a></td></tr>";        
    }
    ?>
    </table>
        </div>
